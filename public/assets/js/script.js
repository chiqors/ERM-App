...
$('#styleSelector').append('' +
    ...
    '<ul>' +
    '<li>' +
    '<p class="selector-title">Choose Theme</p>' +
    '</li>' +
    '<li>' +
    '<div class="theme-color">' +
    '<a href="#" data-toggle="tooltip" title="Light Theme" class="Layout-type waves-effect waves-light" layout-type="light"><span class="head"></span><span class="cont"></span></a>' +
    '<a href="#" data-toggle="tooltip" title="Dark Theme" class="Layout-type waves-effect waves-light" layout-type="dark"><span class="head"></span><span class="cont"></span></a>' +
    '</div>' +
    '</li>' +
    '</ul>' +
    '</div>' +
